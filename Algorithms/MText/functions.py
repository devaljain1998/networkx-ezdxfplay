...
from Algorithms.LineBWRectangleAlgo.pillarplus.math import find_distance, get_angle_between_two_points, directed_points_on_line
...
try:
    identification_json = json.load(json_file_path)
...
def add_text_to_chamber(entity, params):
    ...
    if entity['type'] == 'gully trap chamber':
        ...
        text = f"""F.GL: {entity['finish_floor_level']}
...
add_text_to_chamber(entities[1], params)